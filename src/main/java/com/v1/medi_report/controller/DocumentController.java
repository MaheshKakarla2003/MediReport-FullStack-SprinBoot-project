...
public class DocumentController {
	...
	@PostMapping(value = "/hospitalRole/upload", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
	public ResponseEntity<DocumentSummaryResponse> uploadDocumentForVisit(
